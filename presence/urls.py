...
from presence.views import tableau_presence, marquer_entree, marquer_sortie, fiche_presence_globale, bulletin_paie_temporaire, imprimer_bulletins_temporaire
